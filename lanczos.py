...
if __name__ == "__main__":
    ...
    M[-2,1:] = ds[1]
    M[0,100:] = ds[0]
    print "Eigenvalue of A from 36.3 obtained after {} iterations: {}".format(nits, rvals[-1][0])
    print "True smallest eigenvalue (according to scipy): {}".format(eigvals_banded(M, select='v', select_range=(-1.,1.))[0])
